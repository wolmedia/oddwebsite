...
function Footer() {
  return (
    <>
      <Container className="section_footer bg_footer mobile">
        <Row>
          <Col md={6}>
        ...
        <Row>
          <Col md={6} className="direc">
            <p>
              Dirección:
              <span>
                Guatemala, 5 Avenida 5-55. <br></br>
                Europlaza Torre IV Nivel 18, zona 14.
              </span>
            </p>
          </Col>
          ...
          <Col md={6} className="tel">
            <p>
              ...
              <span>
                2382 2236 <br></br>
                Correo electrónico: <span>soluciones@odd.digital</span>
              </span>
            </p>
          </Col>
        </Row>
      </Container>
      <Container className="section_footer bg_footer desktop">
        <Row>
          <Col>
            <div className="footer-logo">
              <img src={LogoFooter} alt="Logo" />
